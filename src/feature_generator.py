...
# description: generate a set of centroids from image
# input:
#		data_set: a numpy array of images (numpy array)
#		window_size: a tuple (width, height) with the sample size
#		num_cluster: the number of centroids that will be generated
# output:
#		centroids: numpy array with the k-means generated centroids
